...
export default function Navbar() {
  ...
  return (
    <div className={color ? 'fixed z-40 w-full h-20 bg-[#f1c40f] flex items-center' : 'fixed z-40 w-full h-20 bg-transparent flex items-center'}>
        ...
        <img src={color ? "/attachment_96681121.png" : "/attachment_96681121_white.png"} alt="logo" className='w-24 cursor-pointer' onClick={() => navigate('/')} />
        <div className='hidden flex justify-around items-center md:flex w-3/12'>
            <a href="/gallery" className={color ? 'text-[#2c3e50]' : "text-white" }>Gallery</a>
            <a href="/booking" className={color ? 'text-[#2c3e50]' : "text-white" }>Booking</a>
